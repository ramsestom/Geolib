...
declare namespace geolib {    
     ...
     */
    function getVincentyDistance(start: PositionAsDecimal|PositionAsSexadecimal, end: PositionAsDecimal|PositionAsSexadecimal): number;    
     ...
     * Return value is always float and represents the distance in meters.
     */
    function getVincentyDistance(start: PositionAsDecimal|PositionAsSexadecimal, end: PositionAsDecimal|PositionAsSexadecimal, raw: boolean): number;
    

    /** Calculates the distance between two geo coordinates. This method is faster but more inaccurate as compared to getVincentyDistance.
     * 
     * Return value is always float that represents the distance in meters.
     */
    function getHaversineDistance(start: PositionAsDecimal|PositionAsSexadecimal, end: PositionAsDecimal|PositionAsSexadecimal): number;
     ...
     * Return value is always float that represents the distance in meters.
     */
    function getHaversineDistance(start: PositionAsDecimal|PositionAsSexadecimal, end: PositionAsDecimal|PositionAsSexadecimal, raw: boolean): number;
	 ...
	 * Return value is always float that represents the distance in meters.
	 */
	getDistance: function(start: PositionAsDecimal|PositionAsSexadecimal, end: PositionAsDecimal|PositionAsSexadecimal): number;
	 ...
	 * Return value is always float that represents the distance in meters.
	 */
	getDistance: function(start: PositionAsDecimal|PositionAsSexadecimal, end: PositionAsDecimal|PositionAsSexadecimal, raw: boolean): number;
