/*global test:true expect:true gislib:true equal:true asyncTest:true start:true ok:true*/
    ...
    test("Testing distance calculation: getDistance()", function() {
        ...
        var distance1 = gislib.getDistance({latitude: 52.518611, longitude: 13.408056}, {latitude: 51.519475, longitude: 7.46694444});
        var distance2 = gislib.getDistance({latitude: 52.518611, longitude: 13.408056}, {latitude: 51.519475, longitude: 7.46694444}, 100);
        var distance3 = gislib.getDistance({latitude: 37.774514, longitude: -122.418079}, {latitude: 51.519475, longitude: 7.46694444});
        var distance4 = gislib.getDistance({"lat": 41.72977, "lng":-111.77621999999997}, {"lat":41.73198,"lng":-111.77636999999999});
        var distance5 = gislib.getDistance({"lat": 41.72977, "lng":-111.77621999999997}, {"lat":41.73198,"lng":-111.77636999999999}, 1, 3);
        var geoJSON = gislib.getDistance([-111.77621999999997, 41.72977], [-111.77636999999999, 41.73198]);
    ...
    test("Testing distance calculation: getDistanceSimple()", function() {
        ...
        var distance1 = gislib.getDistanceSimple({latitude: 52.518611, longitude: 13.408056}, {latitude: 51.519475, longitude: 7.46694444});
        var distance2 = gislib.getDistanceSimple({latitude: 52.518611, longitude: 13.408056}, {latitude: 51.519475, longitude: 7.46694444}, 100);
        var distance3 = gislib.getDistanceSimple({latitude: 37.774514, longitude: -122.418079}, {latitude: 51.519475, longitude: 7.46694444});
    ...
    test("Testing center calculation: getCenter()", function() {
        ...
        var europe = gislib.getCenter([cities["Berlin"], cities["Moscow"]]);
        var pacific = gislib.getCenter([cities["Sydney"], cities["San Francisco"]]);

        var example = gislib.getCenter(cities)
    ...
    test("Testing in line calculation: isPointInLine()", function(){
        ...
        var isInLine1 = gislib.isPointInLine(point1, start, end);
        var isInLine2 = gislib.isPointInLine(point2, start, end);
        var isInLine3 = gislib.isPointInLine(point3, start, end);
    ...
    test("Testing bounding box: getBounds()", function() {
        ...
        var box = gislib.getBounds(polygon);
    ...
    test("Testing bounding box: getBoundsDistance()", function() {
        ...
        var bounds = gislib.getBoundsOfDistance(point, 1000);
        ...
        nearlyEqual(gislib.getDistance(point, north), 1000, 10);
        nearlyEqual(gislib.getDistance(point, south), 1000, 10);
        nearlyEqual(gislib.getDistance(point, east), 1000, 10);
        nearlyEqual(gislib.getDistance(point, west), 1000, 10);
    ...
    asyncTest("Testing elevation: getElevation()", function() {
        ...
        gislib.getElevation(coords1,function(err, results) {
        ...
        gislib.getElevation(coords2,function(err, results) {
    ...
    test("Testing grade: getGrade()", function() {
        ...
        var grade = gislib.getGrade(coords1);
        equal(grade, 51, "grade should be 51");

        grade = gislib.getGrade(coords2);
    ...
    test("Testing elevation gain and loss: getTotalElevationGainAndLoss()", function() {
        ...
        var gainAndLoss = gislib.getTotalElevationGainAndLoss(coords1);
        ...
        gainAndLoss = gislib.getTotalElevationGainAndLoss(coords2);
    ...
    test("Testing conversion: sexagesimal2decimal()", function() {
        ...
        var dec1 = gislib.useDecimal("51° 31' 10.11\" N");
        var dec2 = gislib.useDecimal("7° 28' 01\" E");
        var dec3 = gislib.useDecimal("19°    22'   32\"      S");
        var dec4 = gislib.useDecimal("71° 3'     34\" W");
        var dec5 = gislib.useDecimal("71°3'W");
        var dec6 = gislib.useDecimal("51.519470");
        var dec7 = gislib.useDecimal("-122.418079");
        var dec8 = gislib.useDecimal("51° 31.52' 10.11\" N");
    ...
    test("Testing different useDecimal() formats", function() {
        ...
        var dec1 = gislib.useDecimal(latToCheck);
        var dec2 = gislib.useDecimal(latExpected);
        var dec3 = gislib.useDecimal({lat: latToCheck, lng: lngToCheck});
        var dec4 = gislib.useDecimal([{lat: latToCheck, lng: lngToCheck}, {lat: latToCheck, lng: lngToCheck}]);
        var dec5 = gislib.useDecimal([latToCheck, lngToCheck]);
        var dec6 = gislib.useDecimal({example: {lat: latToCheck, lng: lngToCheck}});
    ...
    test("Testing conversion: decimal2sexagesimal()", function() {
        ...
        expect(3);
        var sexa1 = gislib.decimal2sexagesimal(51.519475);
        var sexa2 = gislib.decimal2sexagesimal(-19.37555556);
        var sexa3 = gislib.decimal2sexagesimal(50);
    ...
    test("Testing: getCompassDirection()", function() {
        ...
        expect(2);
        var dir1 = gislib.getCompassDirection({latitude: 52.518611, longitude: 13.408056}, {latitude: 51.519475, longitude: 7.46694444});
    ...
    test("Testing: findNearest()", function() {
        ...
        expect(4);
        var near1 = gislib.findNearest({latitude: 36.1168, longitude: -115.173798}, cities);
    ...
    test("Testing: getPathLength()", function() {
        ...
        var pathLength = gislib.getPathLength(polygon);
    ...
    test("Testing: getSpeed()", function() {
        ...
        var speedInKMH = gislib.getSpeed({lat: 51.567294, lng: 7.38896, time: 1360231200880}, {lat: 52.54944, lng: 13.468509, time: 1360245600880});
        var speedInMPH = gislib.getSpeed({lat: 51.567294, lng: 7.38896, time: 1360231200880}, {lat: 52.54944, lng: 13.468509, time: 1360245600880}, {unit: 'mi'});
    ...
    test("Testing: isPointInside()", function() {
        ...
        var isInside1 = gislib.isPointInside({latitude: 51.514252208, longitude: 7.464905736}, polygon); // Point is inside of the polygon
        var isInside2 = gislib.isPointInside({latitude: 51.510539773, longitude: 7.454691884}, polygon); // Point is not inside polygon
    ...
    test("Testing: isPointInsideWithPreparedPolygon()", function() {
        ...
        gislib.preparePolygonForIsPointInsideOptimized(polygon);

        var isInside1 = gislib.isPointInsideWithPreparedPolygon({latitude: 51.514252208, longitude: 7.464905736}, polygon); // Point is inside of the polygon
        var isInside2 = gislib.isPointInsideWithPreparedPolygon({latitude: 51.510539773, longitude: 7.454691884}, polygon); // Point is not inside polygon
    ...
    test("Testing: computeDestinationPoint()", function() {
        ...
        var point1 = gislib.computeDestinationPoint(cities['Berlin'], 15000, 180);
        var point2 = gislib.computeDestinationPoint(cities['Berlin'], 15000, 135);
    ...
    test("Testing: orderByDistance()", function() {
        ...
        var result = gislib.orderByDistance({"latitude": 51.516241842, "longitude": 7.456494328}, polygon2);
        ...
        var result2 = gislib.orderByDistance({lat: 1, lng: 1}, [{lat: 3, lng: 4}, {lat: 1, lng: 6}, {lat: 4, lng: 1}]);
    ...
    test("Testing: convertUnit()", function() {
        ...
        equal(gislib.convertUnit('km', 1000), 1, 'Conversion of 1000 m to km');
        equal(gislib.convertUnit('m', 1000), 1000, 'Conversion of 1000 m to m (just to make sure)');
        equal(gislib.convertUnit('cm', 1000), 100000, 'Conversion of 1000 m to cm');
        equal(gislib.convertUnit('mm', 1000), 1000000, 'Conversion of 1000 m to mm');
        equal(gislib.convertUnit('mi', 1000), 0.6214, 'Conversion of 1000 m to miles');
        equal(gislib.convertUnit('sm', 1000), 0.5399, 'Conversion of 1000 m to seamiles');
        equal(gislib.convertUnit('ft', 1000), 3280.8399, 'Conversion of 1000 m to ft');
        equal(gislib.convertUnit('in', 1000), 39370.0787, 'Conversion of 1000 m to in');
        equal(gislib.convertUnit('yd', 1000), 1093.6133, 'Conversion of 1000 m to  yd');

    });

    test("Testing: isSexagesimal()", function() {

        ok(gislib.isSexagesimal('51° 31\''), '51° 31\'');
        ok(gislib.isSexagesimal('51° 31\' 12"'), '51° 31\' 12"');
        ok(gislib.isSexagesimal('51° 31\' 12.27"'), '51° 31\' 12.27"');
        ok(gislib.isSexagesimal('51° 31\' 12.27" N'), '51° 31\' 12.27" N');
        ok(gislib.isSexagesimal('51° 31.34\' 12.27" N'), '51° 31.34\' 12.27" N');
        ok(gislib.isSexagesimal('51° 31\' N'), '51° 31\' N');

        //ok(gislib.isSexagesimal('51° N'), '51°'); // coming soon
